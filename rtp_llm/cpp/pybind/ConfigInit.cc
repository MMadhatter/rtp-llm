...
PYBIND11_MODULE(libth_transformer_config, m) {
    ...
    py::class_<AttentionConfigs>(m, "AttentionConfigs")
        ...
        .def_readwrite("hc_mult", &AttentionConfigs::hc_mult)
        .def_readwrite("hc_sinkhorn_iters", &AttentionConfigs::hc_sinkhorn_iters)
        .def_readwrite("hc_eps", &AttentionConfigs::hc_eps)
    ...
    py::class_<ModelConfig>(m, "ModelConfig")
        ...
        .def_readwrite("moe_hash_routing_layers", &ModelConfig::moe_hash_routing_layers)
