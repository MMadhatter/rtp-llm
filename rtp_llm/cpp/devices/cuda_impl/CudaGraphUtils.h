...
public:
    ...
    CaptureMemoryHold(at::Tensor hidden_states, PyModelInputs& inputs, bool is_embedding):
        ...
        py_model_inputs_.engram_inputs.decode_ngram_input_host      = inputs.engram_inputs.decode_ngram_input_host;
        py_model_inputs_.engram_inputs.hash_input_ids_host          = inputs.engram_inputs.hash_input_ids_host;
        py_model_inputs_.engram_inputs.hash_input_ids_d             = inputs.engram_inputs.hash_input_ids_d;
    }
